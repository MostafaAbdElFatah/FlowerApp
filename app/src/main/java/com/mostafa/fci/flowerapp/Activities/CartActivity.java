...
import com.mostafa.fci.flowerapp.Utillities.RecyclerViewOnTouchItemHelper;
...
import com.mostafa.fci.flowerapp.interfaces.RecyclerViewOnTouchItemHelperListener;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ItemTouchHelper.SimpleCallback itemCallback
            ...
            public void onSwiped(RecyclerView.ViewHolder viewHolder, int direction, int position) {
                ...
                RoomDatabase.getDatabase(getApplicationContext()).daoDatabase().deleteOrder(userOrder);
                DBServices.removeOrder(order);
                Toast.makeText(CartActivity.this,"Order removed"
